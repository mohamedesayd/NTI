module game(
    ...
    pll u5 (clk_ref, ~rst_n, clk);
    wire [2:0] speed, state;
    clk_divider u1 (pll_clk, rst_n, speed, clk);
    sm u0 (clk, rst_n, loser, boss, start, state, speed, active);
    advertiser u2 (clk, rst_n, state, sevseg0, sevseg1, sevseg2, sevseg3,sevseg4,sevseg5);
