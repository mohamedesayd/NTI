...
synth_design -top bcd_digital_clock -part xazu1eg-sbva484-1-i
...
write_checkpoint -force -noxdef bcd_digital_clock.dcp
OPTRACE "write_checkpoint" END { }
OPTRACE "synth reports" START { REPORT }
generate_parallel_reports -reports { "report_utilization -file bcd_digital_clock_utilization_synth.rpt -pb bcd_digital_clock_utilization_synth.pb"  } 
